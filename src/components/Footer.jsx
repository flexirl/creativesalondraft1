        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#F7F4EE]/75 font-light leading-relaxed">
                SCE-79, 1st Floor, Above Chaayos, Sector 14, Gurugram, Haryana – 122007
              </p>
              <p className="text-[10px] font-mono text-[#9A6548] mt-0.5 tracking-wider uppercase">
                Plus Code: F2FX+75 Gurugram, Haryana
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 pt-1">
              ...
              {/* GET DIRECTIONS */}
              <a
                href="https://maps.app.goo.gl/tJ2aTeefFYUtN6hi9"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="lg:col-span-6 w-full space-y-3">
            ...
            <a
              ...
              title="Open Creative Salon on Google Maps"
            >
              <iframe
                title="Creative Salon Sector 14 Gurugram Location Map"
                src="https://maps.google.com/maps?q=28.4732395,77.0479925+(Creative+Salon)&t=&z=18&ie=UTF8&iwloc=B&output=embed"
